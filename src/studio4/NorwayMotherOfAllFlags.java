...
public class NorwayMotherOfAllFlags {
	...
	public static void france() {
		...
		StdDraw.setPenColor(255, 0, 0);
		StdDraw.filledRectangle(19, 0, 3.65, 16);
	...
	public static void netherlands() {
		StdDraw.clear();
		StdDraw.setPenColor(255, 0, 0);
		StdDraw.filledRectangle(11, 13.5, 11, 3);
		StdDraw.setPenColor(0, 0, 127);
		StdDraw.filledRectangle(11, 2.5, 11, 3);
	}
	...
	public static void poland() {
		...
		StdDraw.clear();
		StdDraw.setPenColor(255, 0, 0);
		StdDraw.filledRectangle(11, 3.5, 11, 5);
	}
	...
	public static void thailand() {
		...
		StdDraw.filledRectangle(11, 14.5, 11, 1.5);
		StdDraw.setPenColor(0, 0, 127);
